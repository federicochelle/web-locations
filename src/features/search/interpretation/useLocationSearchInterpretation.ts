        ...
        (async () => {
          ...
          try {
            ...
            const nextSnapshot = {
              ...
              coreQuery,
              optionalTerms,
              categorySlugs: interpretation.categorySlugs,
              featureSlugs: interpretation.featureSlugs,
              tagSlugs: interpretation.tagSlugs,
              freeTextTerms: interpretation.freeTextTerms,
              usedAi: true,
