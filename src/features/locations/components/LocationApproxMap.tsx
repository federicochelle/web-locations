...
export function LocationApproxMap({
  ...
  if (!googleMapsApiKey) {
    return (
      <div className="flex h-[17rem] w-full items-center justify-center overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/6 px-6 text-center text-sm text-brand-100/72 shadow-[0_18px_34px_rgba(0,0,0,0.12)]">
  ...
  return (
    <div className="h-[17rem] w-full overflow-hidden rounded-[1.5rem] border border-white/10 bg-[#EEE7DE] p-1 shadow-[0_18px_34px_rgba(0,0,0,0.18)]">
      <div className="h-[17rem] w-full overflow-hidden rounded-[1.2rem]">
