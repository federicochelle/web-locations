...
const GMAIL_URL = 'https://mail.google.com/mail/?view=cm&fs=1&to=filmlocationsuy@gmail.com'
...
function EmailIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="h-6 w-6 fill-none stroke-current">
      <rect x="3.5" y="5.5" width="17" height="13" rx="2.5" strokeWidth="1.6" />
      <path d="m5.5 7 6.5 5 6.5-5" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
      ...
      <div className="page-shell py-10 sm:py-12 lg:py-14">
        <div className="grid gap-10 md:gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-center">
          ...
          <div className="flex items-center justify-center gap-4 lg:justify-end">
            ...
            <SocialLink href={GMAIL_URL} label="Email">
              <EmailIcon />
            </SocialLink>
